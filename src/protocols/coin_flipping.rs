...
mod tests {
    ...
    #[test]
    fn test_sequential_coin_flip_string() {
        let result = SequentialCoinFlip::generate_random_string(10);
        assert!(result.is_ok());
    ...
    #[test]
    fn test_sequential_coin_flip_bytes() {
        let result = SequentialCoinFlip::generate_random_bytes(5);
        assert!(result.is_ok());
    ...
    #[test]
    fn test_sequential_coin_flip_field_elements() {
